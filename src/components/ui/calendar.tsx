    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-9 w-9 bg-background/80 p-0 hover:bg-background hover:scale-110 transition-all duration-200 shadow-sm"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-12 font-semibold text-sm uppercase tracking-wide",
        ...
        day: cn(
          ...
          "h-12 w-12 p-0 font-medium aria-selected:opacity-100 hover:bg-accent hover:scale-105 transition-all duration-200"
        ),
