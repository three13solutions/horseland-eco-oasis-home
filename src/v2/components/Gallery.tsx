...
import { Camera, Heart, MapPin, Eye, ArrowRight, ChevronLeft, ChevronRight, X } from 'lucide-react';
import { galleryImages as allGalleryImages } from '@/v2/data';
...
const GalleryV5 = () => {
  ...
  const galleryImages = [...allGalleryImages].sort(
