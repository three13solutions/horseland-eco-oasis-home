...
const CANCELLATION_POLICIES = [
  { code: 'refundable_credit', name: 'Credit Voucher', description: 'Redeemable within 6 Months', icon: CreditCard },
...
const CategoryCard: React.FC<Props> = ({ category, onViewDetails, onBookNow, viewMode = 'grid', checkIn, checkOut, guests = 2, adults = 2, children = 0, hideBookNow = false }) => {
  ...
  const cancellationPolicies = CANCELLATION_POLICIES;
  ...
  }, [selectedMealPlan, adults, children, guests, nights, category.basePrice, checkIn, checkOut]);

  const selectedVariant = checkIn && checkOut ? { placeholder: true } : null;
      ...
      <div className="p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2 w-full">
            <Link to={`/v2/stay/${category.id}`} className="flex-1">
