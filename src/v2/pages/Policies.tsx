...
import { activePolicies, getPageBySlug, getMediaUrl } from '@/v2/data';
...
const Policies = () => {
  ...
  const policies = activePolicies as unknown as PolicyContent[];

  const page = getPageBySlug('policies');
  const heroImage = (page?.hero_image && getMediaUrl(page.hero_image_key, page.hero_image)) || '/lovable-uploads/d4df921c-30f4-4f92-92f2-c84dbcd5b591.png';
