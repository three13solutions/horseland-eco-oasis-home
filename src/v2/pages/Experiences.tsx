...
import { getPageBySlug } from '@/v2/data';

const Experiences = () => {
  const pageData = getPageBySlug('experiences');
  const heroImage = pageData?.hero_image || 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80';
  const heroTitle = pageData?.title || 'Curated Mountain Experiences';
  const heroSubtitle = pageData?.subtitle || 'Every moment at Horseland is designed to reconnect you with nature, nourish your body, and refresh your spirit through authentic mountain experiences.';
