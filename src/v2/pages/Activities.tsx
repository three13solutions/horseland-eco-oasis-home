...
import { activeActivities, getPageBySlug } from '@/v2/data';
...
const Activities = () => {
  ...
  useEffect(() => {
    setActivities(activeActivities as Activity[]);
    setLoading(false);
    ...
    if (page) {
      ...
      if (page.structured_content && typeof page.structured_content === 'object') {
        const settings = page.structured_content as any;
                    ...
                    <div key={activity.id} className="bg-card border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                      <div className="relative">
                        ...
                        <Badge 
                          ...
                          onClick={() => navigate(`/v2/activities/${activity.id}`)}
                        >
                          Learn More
                        </Badge>
                      </div>
