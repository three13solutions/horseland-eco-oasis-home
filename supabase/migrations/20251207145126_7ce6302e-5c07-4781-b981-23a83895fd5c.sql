...
-- Drop the old calculate_dynamic_price with old signature
DROP FUNCTION IF EXISTS public.calculate_dynamic_price(uuid, uuid, date, integer, text, integer);

-- Force recompilation of calculate_rate_variants by recreating it
